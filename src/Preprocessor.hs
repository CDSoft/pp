...
data DiagramRuntime = Graphviz | PlantUML | Asymptote deriving (Show)
...
builtin = [ define, undefine, rawdef
          ...
          ++ [diagram Asymptote diag "" "" | d <- asymptoteDiagrams, let diag = showCap d]
          ++
          [ lit, flushlit
          , source
          , codeblock
