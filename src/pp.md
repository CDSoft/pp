...
<!-- TOC autogenerated/updated with gfmtoc (Node.js):
     https://www.npmjs.com/package/@hail2u/gfmtoc -->
...
- [Diagram and script examples](#diagram-and-script-examples)
    ...
    - [Examples](#examples)
        ...
        - [Python](#python)
        - [Haskell](#haskell)
- [Third-party documentations and tutorials](#third-party-documentations-and-tutorials)
- [Licenses](#licenses)
    - [PP](#pp)
    - [PlantUML](#plantuml-1)
    - [ditaa](#ditaa-1)
