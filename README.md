...
you can get already compiled executables here: <http://cdsoft.fr/pp>.

You can also download 64 bit linux binaries,
...
The [source code](pp.md) of the documentation contains some diagrams.
